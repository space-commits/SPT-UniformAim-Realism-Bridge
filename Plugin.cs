...
namespace Bridge
{
    ...
    [BepInDependency("com.notGreg.UniformAim", BepInDependency.DependencyFlags.HardDependency)]
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        void Update()
        {
            if (CheckIsReady()) 
            {
                RealismMod.Plugin.startingSens = notGreg.UniformAim.Plugin.aimingSens;
            }
